...
def statisticsPage():
    ...
    title = tkinter.Label(root, text="Diabetic Predictor", width=20, font=("arial", 25, "bold"), fg="red",
                          relief="solid")
    title.pack()

    btn1 = tkinter.Button(root, text="Diabetes Vs.\n Pregnancies", width=20, bg="green", fg="white",
                          command=Pregnancies)
    ...
    btn2 = tkinter.Button(root, text="Diabetes Vs.\n BloodPressure", width=20, bg="purple4", fg="white",
