...
def next_page(name, age, gender):
    ...
    title = tkinter.Label(window, text="Diabetic Predictor", width=20, font=("arial", 25, "bold"), fg="red",
                          relief="solid")
    title.pack()
    ...
    btn3 = tkinter.Button(window, text="Get Results", width=12, bg="green", fg="white", command=finalResult)
