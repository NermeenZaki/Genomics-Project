...
def getRersults(inputArray, name, age):
    ...
    featuresColumns = ['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin', 'BMI',
    ...
    # print(bestAcc)
    tkinter.messagebox.showinfo("Result for " + name,
                                "Patient Name: " + name + '\n' + "Patient Age: " + age + '\n' + 'This patient will ' + output + ' diabetes in the future with accurecy = ' + str(
                                    bestAcc))
