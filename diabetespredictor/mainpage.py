...
title = tkinter.Label(root, text="Diabetic Predictor", width=20, font=("arial", 25, "bold"), fg="blue", relief="solid")
title.pack()
...
ageEntry.place(x=250, y=400, height=30)
...
btn1 = tkinter.Button(root, text="Next", width=12, bg="green", fg="white", command=secondPage)
btn1.place(x=90, y=560)

btn2 = tkinter.Button(root, text="Quit", width=12, bg="red", fg="white", command=exitFirstWindow)
